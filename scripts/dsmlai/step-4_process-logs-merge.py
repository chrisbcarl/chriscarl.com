...
ip_api_df = ip_api_df.drop(['status', 'message'], axis=1)  # usually just says "success", not sure where "message" came from
...
merged_df['agent_count'] = merged_df['agents'].apply(lambda lst: len(lst))
